...
export function PartsPanel() {
  ...
  return <section className="panel"><h2>Parts</h2><input type="file" accept="image/png" multiple onChange={async e => { const files = [...(e.currentTarget.files ?? [])]; addParts(await importPngParts(files, parts.length)); e.currentTarget.value = '' }} />
