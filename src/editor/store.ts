...
type State = Project & { selectedPartId?: string; isPlaying: boolean; currentTime: number; editVertices: Record<string, Vec2[]>; savedKeyform?: { partId: string; value: 0 | 1 }; addParts(parts: Part[]): void; selectPart(id: string): void; toggleVisible(id: string): void; movePart(id: string, dir: -1 | 1): void; setParameter(id: string, value: number): void; saveKeyform(value: 0 | 1): void; updatePartVertices(id: string, vertices: Vec2[]): void; play(): void; stop(): void; setTime(t: number): void }
export const useEditorStore = create<State>((set, get) => ({
  parts: [], parameters, parameterValues: { [PARAM_DEFORM_ID]: 0 }, animation, selectedPartId: undefined, isPlaying: false, currentTime: 0, editVertices: {}, savedKeyform: undefined,
  ...
  play: () => set({ isPlaying: true, editVertices: {}, savedKeyform: undefined }),
